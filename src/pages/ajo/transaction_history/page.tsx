...
const TransactionHistoryPage = () => {
    ...
    return (
        <main className="mb-[20px] flex  font-asap  flex-col gap-6">
                <DashboardHeader
                    ...
                    <ul className="flex flex-col gap-3 w-[100%]">
                        {
                            transactionData.map((transaction, index) => (
                                <li
                                    key={index}
                                    className="w-[100%] flex flex-col gap-2 bg-[#ECE6F2] border border-[#93909080] rounded-md p-3">
                                    ...
                                    <div className="w-[100%] flex items-center justify-between">
                                        ...
                                        <Typography className="text-[16px] font-asap font-[600] tracking-tight text-[#440080]">
                                            +{transaction.total.toLocaleLowerCase()}
                                        </Typography>
                                    </div>
                                    <div className="w-[100%] flex items-center justify-between">
                                        <Typography className="text-[14px] font-asap font-[400] tracking-normal text-[#959494]">
