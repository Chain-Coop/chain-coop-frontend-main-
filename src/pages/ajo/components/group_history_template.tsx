...
const GroupHistoryTemplate = (props: GroupHistoryTemplateTypes) => {
    return (
        <div className='flex flex-col gap-0 w-[100%] h-[600px] overflow-auto whitespace-nowrap scrollbar-hide flex-shrink-0'>
            ...
            <div className='flex flex-wrap justify-between gap-4 pb-8  flex-shrink-0'>
                {
