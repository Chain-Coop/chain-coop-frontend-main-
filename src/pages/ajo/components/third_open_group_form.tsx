        ...
        <form className="flex flex-col gap-6 w-[100%] items-center">
            ...
            <div className="flex flex-col gap-2 w-full lg:w-4/5">
                <div className="flex items-center justify-between w-full">
                    ...
                    {
                        data.savings_image && (
                            <button className="text-red-500 font-[500] text-[14px] flex self-end -translate-y-1 tracking-tighter items-center gap-1 bg-transparent" onClick={resetImage}>
                ...
                <div
                    className="w-[100%] p-4 flex items-center justify-center border-2 border-dashed border-black rounded-lg h-[160px] flex-col gap-2 relative cursor-pointer"
                    tabIndex={0}>
            ...
            <div className="flex items-start 2xl:self-auto sm:items-center self-start lg:self-center gap-2 ">
