...
const SourceFunds = () => {
  ...
  const handleNext = () => {
    ...
    console.log("Navigating with formData:", updatedFormData); // Debug log
              ...
              <div>
                <input
                  ...
                  onChange={() => {
                    ...
                    setTokenAmount(""); // Clear token amount when switching to Naira
                  }}
                />
              ...
              <div>
                <input
                  ...
                  onChange={() => {
                    ...
                    setAmount(""); // Clear Naira amount when switching to Tokens
                  }}
                />
