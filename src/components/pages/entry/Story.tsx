      ...
      >
        ...
        <section className="relative lg:absolute lg:inset-0">
          <div className="mx-auto px-[1em] lg:w-[80%]">
            <header className="mx-auto mt-1 text-center md:-mt-20 md:w-full md:px-4 lg:mt-[9em] lg:w-[75%]">
            ...
            <div className="m-auto mt-2 flex flex-col lg:mt-[3em] lg:w-full lg:gap-8 lg:text-start">
              ...
              <div className="relative mt-4 flex flex-col-reverse md:mt-12 lg:z-[10] lg:mt-[-150px] lg:flex-row">
                <div className="mt-3 flex flex-col items-center lg:ml-0 lg:mt-[8em] lg:w-[50%] lg:items-start">
                  <h1 className="md:-[2.5em] mt-[2em] w-full text-center text-xl font-bold md:text-3xl lg:mt-[5em] lg:w-[60%] lg:text-left">
                    Join Our Tech-Driven Cooperative
                  </h1>
                  <p className="mt-[1em] w-full text-center text-sm font-medium text-gray-700 md:text-base lg:mt-[2.2em] lg:text-start">
                    Join Our Tech-Driven Cooperative
                  </p>
                  <p className="mt-[1em] w-full text-center text-sm font-medium text-gray-700 md:text-base lg:mt-[1.7em] lg:w-[90%] lg:text-start">
                  ...
                  <div className="mt-[2.5em] flex w-full flex-col gap-3 font-medium lg:gap-7">
        ...
        <div className="mx-auto mt-[1.5em] flex flex-col justify-between gap-4 px-4 lg:mt-3 lg:w-[87%] lg:flex-row">
          <div className="h-full rounded-lg bg-text2 px-6 py-6 text-text3 shadow-md md:px-8 md:py-10 lg:py-[6em]">
          ...
          <div className="mb-6 h-full rounded-lg px-6 py-6 shadow-md md:px-8 md:py-10 lg:mt-[5em] lg:py-[6em]">
