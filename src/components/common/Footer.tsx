    ...
    <footer className="w-full overflow-hidden">
      <div className="relative z-10 mx-auto flex items-center justify-center w-full rounded-2xl bg-[#CCA3BC] font-sans p-4 sm:py-3 lg:p-8 sm:mb-[-70px] sm:mt-[2em] lg:mb-[-100px] lg:w-[90%]">
        <div className="text-center w-full px-4">
          ...
          <form onSubmit={joinNews} className="flex flex-col items-center justify-center gap-4 w-full lg:max-w-[60%] mx-auto lg:flex-row">
            <input
              type="email"
            ...
            />
            <button type="submit" className="w-full lg:w-[30%] flex text-center justify-center rounded-md bg-text2 px-4 py-2 text-lg text-text5 lg:text-xl">
              {loading ? (
                <ReactLoading
                  color="#FFFFFF"
                  width={25}
      ...
      <div className="w-full bg-text2 font-sans">
        <div className="mx-auto lg:w-[90%] px-6 pt-[120px] lg:pt-[190px] lg:pb-[10px]">
        ...
        <div className="px-6 py-8 flex flex-col items-center lg:flex-row lg:justify-between lg:px-[5em]">
