    ...
    return (
        <form className="flex flex-col gap-6 w-[100%] items-center">
            ...
            <label htmlFor="group_title" className="flex flex-col gap-2 w-[100%] lg:w-[80%]">
                ...
                <textarea rows={3}  className="text-[16px] border-2 border-[#95949480] rounded-lg py-2 px-4 outline-none focus:shadow-xl shadow-lg font-[400] text-[#1E1E1E99]" />
            </label>
            ...
            <div  className="flex flex-col gap-2 w-[100%] lg:w-[80%]">
                ...
                <div className="w-[100%] flex flex-wrap justify-between gap-1 gap-y-3">
                    <button className="border-2 border-[#440080] rounded-lg bg-[#ECE6F2] p-2 flex items-center w-[120px] gap-2 justify-center">
