    ...
    return (
        <main className="flex flex-col font-sans  gap-8 mb-[20px]">
            ...
            <section className="flex flex-col gap-3">
                <h3 className="text-[20px] lg:text-[22px] font-[600] pb-3 w-[100%] border-b-[1.5px] border-b-[#DDD8D8B2]">
                    Other Saving Groups
                </h3>
                <section className="w-[100%] flex gap-4 overflow-x-auto scrollbar-hide py-2">
                    {
            ...
            {/* JOINT SAVINGS GROUP */}
            <section className="w-[100%] flex flex-col px-4 mt-12">
                <GroupHistoryTemplate description="This are the list of active groups you joined." historyList={otherGroupSavings} length={`Savings groups (${otherGroupSavings.length})`} title="Joint Saving Groups" key={2} />
            </section>
