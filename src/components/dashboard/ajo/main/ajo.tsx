...
const AjoPage = () => {
  ...
  return (
    <main className="mb-[40px] flex   flex-col gap-8">
      <DashboardHeader className="flex items-center justify-center text-2xl  md:text-3xl lg:mt-[2em] lg:text-xl">
        Group Savings
      </DashboardHeader>

      <section className="mb-[20px] flex   flex-col gap-8 px-4 lg:px-6">
        <section className="w-[100%] rounded-3xl border-[2px] border-gray-200 bg-white p-8 shadow-md sm:p-16">
        ...
        <section className="flex w-[100%] flex-col gap-4">
          ...
          <Typography className="tracking-medium text-[14px] font-[400] text-[#302B2BC7] xl:text-[16px]">
            Select any of the saving option to begin your contribution with
            others
          </Typography>
          <div className="flex w-[100%] flex-wrap justify-between gap-y-4 2xl:justify-center  2xl:gap-6">
            {groupSavingsOptions.map((group, index) => (
              <Link
                className={`flex h-[150px] w-[100%] flex-col items-center gap-2 rounded-lg p-2 hover:ring-2 hover:ring-[#440080] md:h-fit md:w-[49%] lg:w-[100%] xl:w-[240px] ${groupOption === index && "ring-2 ring-[#440080]"}`}
              ...
              >
                ...
                <Typography className="w-[100%] text-center text-[13px] font-[400] text-[#565454] md:text-[14px] lg:text-[15px]">
                  {group.text}
                </Typography>
              </Link>
            ))}
        ...
        <section className="flex w-[100%] flex-col gap-3">
          ...
          <div className="flex w-[100%] justify-between border-b-[1.5px] border-b-[#DDD8D8B2]">
            <button
              className={`pb-5 text-[16px] font-[500] text-[#1E1E1E]  lg:text-[18px] ${groupHistory === "ongoing" ? "border-b-[2.5px] border-b-[#440080] opacity-100" : "opacity-50"}`}
              onClick={() => setGroupHistory("ongoing")}
            >
              Ongoing
            </button>
            <button
              className={`pb-5 text-[16px] font-[500] text-[#1E1E1E]  lg:text-[18px] ${groupHistory === "completed" ? "border-b-[2.5px] border-b-[#440080] opacity-100" : "opacity-50"}`}
        ...
        <section className="mt-12 flex w-[100%] flex-col items-center justify-center gap-4">
          <img
            src={createImage}
          ...
          <Link
            to={"/dashboard/ajo/create_open_group"}
