    ...
    <main className="font-sans pb-[1.5em]">
          ...
          <section className="mt-[2em]">
            <div className="flex justify-center">
              <div onClick={fundContribution}>
                <button className="rounded-full text-text2 font-bold bg-inherit text-lg shadow-lg whitespace-nowrap sm:px-[1em] sm:py-[5px] lg:px-[3em] lg:py-[10px]">
                  Add Savings
                </button>
              </div>
            </div>
      ...
      {isContributionsLoading ? (
          ...
          <div className="px-2 bg-text2 rounded-lg flex flex-col h-auto gap-[1em] mt-[1em] text-center py-[1.5em]">
            ...
            {getContributions?.contributions?.map((contribution: Contribution) => (
              <div
                ...
                onClick={() => navigateToContributionDetails(contribution?.contributionId)}
          ...
          <div className="w-full px-2 bg-text2 rounded-lg flex flex-col h-auto gap-[1em] mt-[1em] text-center py-[3em]">
            ...
            <div onClick={fundContribution} className="cursor-pointer">
              <p className="text-how1 font-semibold mt-[1.5em] text-xl">Get Started</p>
            </div>
          </div>
        )}
      </section>
