    ...
    <main className="pb-[1.5em] font-sans">
      ...
      <section className="sm:px-[1.5em] lg:mx-auto lg:w-[33em] lg:px-[0]">
        <article className="text-center text-text4">
          ...
          <section>
            <div className="mt-[1.5em] rounded-2xl bg-text2 py-[1em]">
              <div className="m-auto flex w-[60%] flex-col items-center rounded-full border-2 border-gray-500 bg-white py-2">
