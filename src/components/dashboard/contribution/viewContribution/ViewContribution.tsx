...
//     fetchWalletBalance,
//   } = useCryptoWallet();
//   console.log("walle", cryptoBalance);
...
//   const fetchCryptoWalletBalance = () => {
...
//                     className={`flex w-auto transform items-center gap-2 rounded-full border border-text2 px-6 font-medium transition-all duration-300
      ...
      <section className="px-3">
        ...
        hover:scale-105 active:scale-95 lg:py-2`}
            ...
            <div className="rounded-3xl py-[2em] shadow-md">
              ...
              {["BTC", "ETH"].includes(contributionDetails?.currency) ? (
                <div className="mx-auto mt-6 w-80 overflow-hidden rounded-lg bg-white shadow-sm">
                  <div className="bg-[#C5b0d8] p-6">
                    <div className="text-center">
                      <p className="font-semibold">
                        {contributionDetails.currency} Wallet balance
                      </p>
                      <p className="mt-2 text-xl font-bold text-text2">
                        {contributionDetails.currency}{" "}
                        {cryptoBalance?.bal || "10.00"}
                      </p>
                    </div>
                  </div>
                </div>
