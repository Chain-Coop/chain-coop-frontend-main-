...
const Transactions = () => {
  ...
  return (
    <main className="px-4 font-sans md:px-8">
      ...
      <div className="mt-4 flex flex-col gap-2 md:mt-6">
        <div className="relative w-full md:w-[70%]">
          <input
            type="text"
            className="w-full rounded-full border border-gray-300 bg-gray-50 px-4 py-2 text-sm placeholder-gray-400 shadow-md focus:border-gray-500 focus:outline-none"
            placeholder="Search"
          />
          <FiSearch className="absolute right-4 top-1/2 -translate-y-1/2 transform text-lg text-gray-500" />
        </div>

        <div className="mt-2 flex flex-col gap-2 justify-between md:w-[80%] md:flex-row">
      ...
      <div className="mt-6 w-full rounded-lg border-b-4 border-red-600 bg-rec1 p-3 shadow-lg">
        ...
        <hr className="my-4 h-[1px] rounded-full bg-gray-200" />
        <div className="mt-4 justify-between flex flex-col gap-2 ">
          <div className="flex justify-between">
            <p className="text-sm jus font-medium text-gray-400 md:text-base">
              Receiver:
