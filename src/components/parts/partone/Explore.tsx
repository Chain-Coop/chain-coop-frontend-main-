...
//       <section className="sm:px-[1.5em] lg:w-[89%] lg:px-[0]">
//         <header className="py-8 text-text4">
//           <h1 className="mb-2 text-center font-bold sm:text-[1.2em] md:text-2xl lg:text-3xl">
...
//               businesses backed by the power of block chain and cooperative
//               ownership .
//             </p>
//           </div>
//         </header>
  ...
  return (
    <main className="flex h-full items-center justify-center font-sans sm:mt-[1em] lg:mt-[5em]">
      <section className="lg:w-[89%] lg:px-[0]">
        <header className="py-8 text-text4">
          <h1 className="mb-2 text-center font-bold sm:text-[1em] md:text-2xl lg:text-3xl">
            Explore Our Investment Opportunities
          </h1>
          <div className="m-auto lg:w-[53%]">
            <p className="font-sans sm:text-center lg:mt-[1.5em]">
