// import person1 from "../../../../public/images/jpg/man-laptop.jpg";
...
import explore1 from "../../../../public/images/jpg/home/explore1.jpg";
import explore2 from "../../../../public/images/jpg/home/explore2.jpg";
import Explore3 from "../../../../public/images/jpg/home/explore3.jpg";
  ...
  return (
    <main className="flex h-full items-center justify-center font-sans sm:mt-[1em] lg:mt-[5em]">
      <section className="sm:px-[1em] lg:w-[86%] lg:px-[0]">
        ...
        <section className="grid justify-center gap-[40px] rounded-xl sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
          <div>
            <img src={explore1} alt="man" />
          </div>

          <section className="grid w-[50%] grid-cols-1 gap-[1em] sm:w-auto">
            <div>
              <img src={explore2} alt="woman" />
            </div>

            <div>
              <img src={Explore3} alt="woman" />
            </div>
          </section>
        </section>
      </section>
